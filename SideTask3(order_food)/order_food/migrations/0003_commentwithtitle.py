# Generated by Django 4.2.11 on 2024-03-23 21:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('order_food', '0002_alter_food_is_available'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_comments', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
